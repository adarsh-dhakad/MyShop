...
class DashboardFragment : BaseFragment(){
   ...
   fun successProductsListFromFireStore(dashboadItemList : ArrayList<Product>){
       hideProgressDialog()
       ...
       if (dashboadItemList.size > 0){
           ...
           if(rvMyProductItems != null) {
              ...
              if (tvNoDashboardItemFound != null) {
               ...
               val adapter = MyDashboardListAdapter(requireActivity(), dashboadItemList)
